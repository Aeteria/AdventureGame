...
public class game
{
    ...
    private ArrayList<Item> SpellStartItems = new ArrayList<Item>();
    ...
    private Item item10 = new Item("Fireball", 1, 12, 12, 0);
    private Item item11 = new Item("Icebolt", 1, 12, 12, 0);
    private Item item12 = new Item("Shock", 1, 12, 12, 0);
    private Item item13 = new Item("Earth", 1, 12, 12, 0);
    ...
    public game(){
        ...
        SpellStartItems.add(item10);
        SpellStartItems.add(item11);
        SpellStartItems.add(item12);
        SpellStartItems.add(item13);
    }

    public void goToStarttingShop(player x){
        ...
        do{
            ...
            System.out.println("4.) Pick a Spell");
            System.out.println("5.) Go Back");
            intOption = sc.nextInt();
            buffer = sc.nextLine();
            if(intOption == 1){
                System.out.println("Choose a Sword Weapon");
                for(int i = 0; i < SwStartItems.size(); i++){
                    System.out.println(i+1 + ".) " + SwStartItems.get(i).getName());
                }
                intOption = sc.nextInt();
                buffer = sc.nextLine();
                x.setMoney(x.getMoney() - SwStartItems.get(intOption-1).getValue());
                x.addItem(SwStartItems.get(intOption-1));
            }else if(intOption == 2){
            	System.out.println("Choose a Blunt Weapon");
                for(int i = 0; i < BlStartItems.size(); i++){
                    System.out.println(i+1 + ".) " + BlStartItems.get(i).getName());
                }
                intOption = sc.nextInt();
                buffer = sc.nextLine();
                x.setMoney(x.getMoney() - BlStartItems.get(intOption-1).getValue());
                x.addItem(BlStartItems.get(intOption-1));
            }else if(intOption == 3){
            	System.out.println("Choose a Dagger Weapon");
                for(int i = 0; i < DgStartItems.size(); i++){
                    System.out.println(i+1 + ".) " + DgStartItems.get(i).getName());
                }
                intOption = sc.nextInt();
                buffer = sc.nextLine();
                x.setMoney(x.getMoney() - DgStartItems.get(intOption-1).getValue());
                x.addItem(DgStartItems.get(intOption-1));
            }else if(intOption == 4){
            	System.out.println("Choose a Spell");
                for(int i = 0; i < SpellStartItems.size(); i++){
                    System.out.println(i+1 + ".) " + SpellStartItems.get(i).getName());
                }
                intOption = sc.nextInt();
                buffer = sc.nextLine();
                x.setMoney(x.getMoney() - SpellStartItems.get(intOption-1).getValue());
                x.addItem(SpellStartItems.get(intOption-1));
            }else if(intOption == 5){
